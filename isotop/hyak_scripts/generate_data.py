...
def write_nmr_spectra(index, num_peaks, x_res_1, y_res_1, x_res_2, y_res_2, res_1, res_2):
    ...
    dir_path = "/home/fostooq/NMR_Upscale_UW_DIRECT/sprectra_data"
    os.makedirs(dir_path, exist_ok=True)

    # Then, when writing your file:
    filename=f"{dir_path}/{str(res_1)}MHz/"+"spectral_data"+ "_"+str(num_peaks).zfill(2)+ "_" +str(index).zfill(5)+".csv"
